            ...
            <div class="bg-white rounded mt-3 p-4">
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown float-end ">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a type="button" id="gerenciarVendaBtn" class="dropdown-item" href="/LootCommerce/adm/gerenciarProduto.jsp">
                                                        Gerenciar
                                                    </a>
                                                </li>
                                            </ul>
                    ...
                    <div class="modal fade" id="cadastrarModal" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="cadastrarLabel" style="display: none;" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form class="needs-validation" action="..." method="POST" novalidate="">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-2">
                                            <div class="col-md-12 h6 fw-bold">Dados do produto</div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                    <input class="form-control" type="number" name="quantProduto" id="quantProduto" required>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" name="vlrCompra" id="vlrCompra" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-floating">
                                                    <select multiple="" aria-label="multiple select example"
                                                        id="categoria" class="form-select">
