                            ...
                            <div class="tab-pane fade" id="v-pills-clientes" role="tabpanel" aria-labelledby="v-pills-clientes-tab">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="cadastrar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="cadastrarLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="needs-validation text-center w-75 p-3" id="form-cadastro" novalidate="">
                                                        <h1 class="h3 mb-3 fw-normal">Novo Cliente</h1>
