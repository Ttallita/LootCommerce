                  ...
                  <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row g-3">
                              <div class="col-sm-6">
                                <div class="input-group form-floating">
                                  <input type="text" class="form-control" id="nome" value="Tiger" required=""
                                    disabled="">
                                  <button onclick="editar('nome')" id="editarNome" class="btn btn-primary"
                              ...
                              <div class="col-4">
                                <div class="input-group form-floating">
                                  <input type="text" class="form-control" id="cpf" value="123.456.789-10" required=""
                                    disabled="">
                                  <button onclick="editar('cpf')" class="btn btn-primary" id="editarCpf"
                                    type="button"><span class="material-icons">mode_edit</span></button>
                    ...
                    <div class="tab-pane fade" id="nav-endereco" role="tabpanel" aria-labelledby="nav-endereco-tab">
                      ...
                      <div class="d-grid gap-2">
                        <div class="d-grid gap-2">
                          <button type="button" id="novoEndereco" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#cadastrarEndereco">
                            Novo Endereço
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade" id="nav-cartoes" role="tabpanel" aria-labelledby="nav-cartoes-tab">
                      ...
                      <div class="d-grid gap-2">
                        <button type="button" id="novoCartao" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#cadastrarCartao">
                          Novo Cartão
                        </button>
                      </div>
