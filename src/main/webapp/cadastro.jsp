                  ...
                  <main>
                    <form class="needs-validation" id="form-cadastro" action="/LootCommerce/cadastro" method="POST"
                      ...
                      <div class="tab row g-3 mb-3">
                        ...
                        <div class="col-6">
                          <div class="form-floating">
                            <input type="password" class="form-control" name="senhaConfirmacao" id="senhaConfirmacao"
                              placeholder="" value="${cliente.usuario.confirmarSenha}">
                        ...
                        <div class="col-md-5">
                          <div class="form-floating">
                            <input type="text" class="form-control" id="logradouro" placeholder=""
                              value="${cliente.enderecos[0].logradouro}" name="logradouro">
                        ...
                        <div class="col-md-3">
                          <div class="form-floating">
                            <input type="text" class="form-control" id="numero" placeholder=""
                              value="${cliente.enderecos[0].numero}" name="numero">
                        ...
                        <div class="col-md-4">
                          <div class="form-floating">
                            <input type="text" class="form-control" id="bairro" placeholder=""
                              value="${cliente.enderecos[0].bairro}" name="bairro">
