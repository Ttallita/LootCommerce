                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                        ...
                                        <form class="needs-validation text-center" novalidate="">
                                          ...
                                          <div style="overflow:auto;">
                                            <div style="float:right;">
                                              <button class="btn btn-primary btn-lg" type="button" id="prevBtn" onclick="nextPrev(-1)">Anterior</button>
                                              <button class="btn btn-primary btn-lg" type="button" id="nextBtn" onclick="nextPrev(1)">Próximo</button>
                                            </div>
                                          </div>
                                        </form>
                                    </main>
                                    ...
                                    <div class="text-center"><a class="small" href="#">Entrar</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
