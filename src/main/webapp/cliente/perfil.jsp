        ...
        <div class="row mt-3 mb-3 bg-white rounded p-4">
            <div class="col-lg-2">
                ...
                <div class="list-group btn-group-vertical">
                    <button class="${empty aba ? 'active' : ''} btn btn-primary" id="v-pills-conta-tab"
                        data-bs-toggle="pill" data-bs-target="#v-pills-conta" type="button"
                        aria-controls="v-pills-conta" aria-selected="true">
                        <span class="material-icons inline-icon">home</span>Conta</button>

                    <button class="${not empty aba && aba == 'senha' ? 'active' : ''} btn btn-primary"
                    ...
                    <button class="${not empty aba && aba == 'endereco' ? 'active' : ''} btn btn-primary"
                    ...
                    <button class="${not empty aba && aba == 'cartoes' ? 'active' : ''} btn btn-primary"
                    ...
                    <button class="btn btn-primary" id="v-pills-compras-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-compras" type="button" aria-controls="v-pills-compras"
                        aria-selected="false">
            ...
            <div class="col-lg-10">
                <div class="tab-content border rounded m-3 p-3">
                    <!--conta-->
                                    ...
                                    <div class="vstack gap-3 text-center">
                                        ...
                                        <div class="col-6 form-floating">
                                            <input type="password" class="form-control" id="senhaConfirmacao"
                                                placeholder="" name="senhaConfirmacao">
                    ...
                    <div class="tab-pane fade" id="v-pills-compras" role="tabpanel"
                        ...
                        <div class="card-body">
                            <div class="col-md-12 h4 fw-bold">Compras</div>
                                    ...
                                    <div class="dropdown float-end ">
                                        <a href="#" aria-expanded="false" data-bs-toggle="dropdown"
                                            class="text-decoration-none"><span
                                                class="material-icons">more_vert</span></a>
