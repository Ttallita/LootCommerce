...
-- Produtos
INSERT INTO produtos (pro_fab_id, pro_grp_id, pro_nome, pro_valor_compra, pro_valor_venda, pro_quant_estoque, pro_descricao, pro_material, pro_cod_barras, pro_link) VALUES
    (30, 2, 'Hatsune Miku Vocaloid', 90.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0010-Z', '/link'),
    (5, 4, 'Rei Neon Genesis Evangelion', 100.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0020-Z', '/link'),
    (16, 5, 'Levi Ackerman Shingeki no Kyojin', 180.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0030-Z', '/link'),
    (16, 1, 'Katsuki Bakugou Tiger My Hero Academia', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0040-Z', '/link'),
    (7, 4, 'pro_nome', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0050-Z', '/link'),
    (25, 5, 'pro_nome', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0060-Z', '/link'),
    (19, 3, 'pro_nome', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0070-Z', '/link'),
    (19, 3, 'pro_nome', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0080-Z', '/link'),
    (19, 3, 'pro_nome', 0.0, 300., 100, 'pro_descricao', 'pro_material', 'A-0090-Z', '/link');
